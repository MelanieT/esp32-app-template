...
esp_err_t NeoPixelWiFiEventHandler::staConnected(wifi_event_sta_connected_t *info) {
...
esp_err_t NeoPixelWiFiEventHandler::staDisconnected(wifi_event_sta_disconnected_t *info) {
...
esp_err_t NeoPixelWiFiEventHandler::staGotIp(ip_event_got_ip_t *info) {
